...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['api_platform.metadata.property.metadata_factory'] = new \ApiPlatform\Core\Metadata\Property\Factory\CachedPropertyMetadataFactory($this->get('api_platform.cache.metadata.property'), new \ApiPlatform\Core\Bridge\Symfony\Validator\Metadata\Property\ValidatorPropertyMetadataFactory($this->get('validator'), new \ApiPlatform\Core\Metadata\Property\Factory\SerializerPropertyMetadataFactory($this->get('api_platform.metadata.resource.metadata_factory'), $this->get('serializer.mapping.cache_class_metadata_factory'), new \ApiPlatform\Core\Bridge\Doctrine\Orm\Metadata\Property\DoctrineOrmPropertyMetadataFactory($this->get('doctrine'), new \ApiPlatform\Core\Metadata\Property\Factory\ExtractorPropertyMetadataFactory($this->get('api_platform.metadata.extractor.xml'), new \ApiPlatform\Core\Metadata\Property\Factory\ExtractorPropertyMetadataFactory($this->get('api_platform.metadata.extractor.yaml'), new \ApiPlatform\Core\Metadata\Property\Factory\InheritedPropertyMetadataFactory($this->get('api_platform.metadata.resource.name_collection_factory'), new \ApiPlatform\Core\Bridge\Symfony\PropertyInfo\Metadata\Property\PropertyInfoPropertyMetadataFactory($this->get('property_info'), new \ApiPlatform\Core\Metadata\Property\Factory\AnnotationPropertyMetadataFactory($this->get('annotation_reader'))))))))));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('VHvEvSpmis', 0, (__DIR__.'/pools'));
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool($this->get('api_platform.cache.route_name_resolver'));
        $a->addPool($this->get('api_platform.cache.metadata.resource'));
        $a->addPool($this->get('api_platform.cache.metadata.property'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_14cece245e974f4833c71263a41919e5ada3ac8605978365ef423dd55b42f9d0');
    ...
    protected function getPropertyInfoService()
    {
        ...
        return $this->services['property_info'] = new \Symfony\Component\PropertyInfo\PropertyInfoExtractor(array(0 => new \Symfony\Component\PropertyInfo\Extractor\SerializerExtractor($this->get('serializer.mapping.cache_class_metadata_factory')), 1 => $c, 2 => $a), array(0 => $a, 1 => $c, 2 => $b), array(0 => $b), array(0 => $c));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'validator.mapping.cache.prefix' => 'validator_ce9aa57409e8e752e49adec6e37d2bef4928e5ac18ea0284ec87f381e7462cb8',
