...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['admin.register.validate'] = new \Application\AdminBundle\Validator\RegisterValidation($this->get('validator'), $this->get('request_stack'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Application\AdminBundle\Model\UserManager A Application\AdminBundle\Model\UserManager instance
     */
    protected function getAdmin_UserManagerService()
    {
        return $this->services['admin.user_manager'] = new \Application\AdminBundle\Model\UserManager($this->get('admin.user'), $this->get('admin.util_canonical_password_updater'), $this->get('admin.util_canonical_fields_updater'));
    }
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('89ErCvMU+5', 0, 'T4bzbIzVQzXO8MKqA1SFbb', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XjpAxhtQa1', 0, 'T4bzbIzVQzXO8MKqA1SFbb', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3RTCZUV4M+', 0, 'T4bzbIzVQzXO8MKqA1SFbb', (__DIR__.'/pools'), $a));
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/Application/AdminBundle/Resources/config/doctrine') => 'Application\\AdminBundle\\Entity'));
        ...
        $c->setEntityNamespaces(array('ApplicationAdminBundle' => 'Application\\AdminBundle\\Entity'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Application/ClientBundle/Resources/views'), 'ApplicationClient');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ApplicationClientBundle' => 'Application\\ClientBundle\\ApplicationClientBundle',
