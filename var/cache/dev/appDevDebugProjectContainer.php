...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('89ErCvMU+5', 0, '3sJoL6uv3yDw8ef7TU3r8I', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XjpAxhtQa1', 0, '3sJoL6uv3yDw8ef7TU3r8I', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3RTCZUV4M+', 0, '3sJoL6uv3yDw8ef7TU3r8I', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '52.29.239.198', 'port' => 3306, 'dbname' => 'sql7148029', 'user' => 'sql7148029', 'password' => 'hMSA8k8MFi', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array('enum' => 'string'));
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/Application/AdminBundle/Resources/config/doctrine') => 'Application\\AdminBundle\\Entity', ($this->targetDirs[3].'/src/Application/ProductBundle/Resources/config/doctrine') => 'Application\\ProductBundle\\Entity'));
        ...
        $c->setEntityNamespaces(array('ApplicationAdminBundle' => 'Application\\AdminBundle\\Entity', 'ApplicationProductBundle' => 'Application\\ProductBundle\\Entity'));
