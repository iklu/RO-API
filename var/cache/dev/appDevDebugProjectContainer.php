...
class appDevDebugProjectContainer extends Container
{
    ...
    /**
     * Gets the 'application_admin.login' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getApplicationAdmin_LoginService()
    {
        return $this->services['application_admin.login'] = new \Application\AdminBundle\Services\Login($this->get('doctrine.orm.default_entity_manager'), $this->get('security.encoder_factory'));
    }
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('89ErCvMU+5', 0, 'qQ5eNtfpKQ6AemMXeNqnAX', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XjpAxhtQa1', 0, 'qQ5eNtfpKQ6AemMXeNqnAX', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3RTCZUV4M+', 0, 'qQ5eNtfpKQ6AemMXeNqnAX', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '52.24.27.64', 'port' => NULL, 'dbname' => 'api_platform', 'user' => 'mnk', 'password' => 'mnkdevelop13#', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
