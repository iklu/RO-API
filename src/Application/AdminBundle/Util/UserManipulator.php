...
use Application\AdminBundle\Event\UserEvent;
...
class UserManipulator
{
    ...
    public function create($username, $password, $email, $active, $superadmin)
    {
        ...
        $this->dispatcher->dispatch(ApplicationAdminEvents::USER_CREATED, $event);
        return $user;
    }
    /**
    ...
    public function activate($username)
    {
        ...
        $this->userManager->updateUser($user);
        $event = new UserEvent($user, $this->getRequest());
        $this->dispatcher->dispatch(ApplicationAdminEvents::USER_ACTIVATED, $event);
    }
    /**
    ...
    public function deactivate($username)
    {
        ...
        $this->userManager->updateUser($user);
        $event = new UserEvent($user, $this->getRequest());
        $this->dispatcher->dispatch(ApplicationAdminEvents::USER_DEACTIVATED, $event);
    }
    /**
    ...
    public function changePassword($username, $password)
    {
        ...
        $this->userManager->updateUser($user);
        $event = new UserEvent($user, $this->getRequest());
        $this->dispatcher->dispatch(ApplicationAdminEvents::USER_PASSWORD_CHANGED, $event);
    }
    /**
    ...
    public function promote($username)
    {
        ...
        $this->userManager->updateUser($user);
        $event = new UserEvent($user, $this->getRequest());
        $this->dispatcher->dispatch(ApplicationAdminEvents::USER_PROMOTED, $event);
    }
    /**
    ...
    public function demote($username)
    {
        ...
        $this->userManager->updateUser($user);
        $event = new UserEvent($user, $this->getRequest());
        $this->dispatcher->dispatch(ApplicationAdminEvents::USER_DEMOTED, $event);
    }
    /**
