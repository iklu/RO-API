...
class ResettingListener implements EventSubscriberInterface
{
    ...
    {
        return array(
            ApplicationAdminEvents::RESETTING_RESET_INITIALIZE => 'onResettingResetInitialize',
            ApplicationAdminEvents::RESETTING_RESET_SUCCESS => 'onResettingResetSuccess',
            ApplicationAdminEvents::RESETTING_RESET_REQUEST => 'onResettingResetRequest',
        );
    }
